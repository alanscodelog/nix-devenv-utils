...
in
{
  ...
  config = lib.mkIf cfg.enabled {
    ...
    tasks."android:loadEnv" = {
      description = "Loads the android keystore paths into the shell.";
      exec = lib.optionalString (builtins.getEnv "SECRETS_DIR" != "") ''
      ...
      '';
      exports = [ "ANDROID_KS_PATH" "ANDROID_KS_PASSWORD_PATH" "ANDROID_KS_ALIAS_PASSWORD_PATH" ];
      showOutput = true;
